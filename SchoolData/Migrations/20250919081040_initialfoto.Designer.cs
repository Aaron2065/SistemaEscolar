...
namespace SchoolData.Migrations
{
    ...
    [Migration("20250919081040_initialfoto")]
    partial class initialfoto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolData.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("SchoolData.Models.EmergencyContact", b =>
                {
            ...
            modelBuilder.Entity("SchoolData.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("SchoolData.Models.Group", b =>
                {
            ...
            modelBuilder.Entity("SchoolData.Models.Pay", b =>
                {
            ...
            modelBuilder.Entity("SchoolData.Models.PayType", b =>
                {
                    b.Property<int>("IdPayType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolData.Models.Student", b =>
                {
                    b.Property<int>("IdStudent")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolData.Models.StudentCourse", b =>
                {
            ...
            modelBuilder.Entity("SchoolData.Models.Teacher", b =>
                {
            ...
            modelBuilder.Entity("SchoolData.Models.Tutor", b =>
                {
                    b.Property<int>("IdTutor")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolData.Models.Course", b =>
                {
                    b.HasOne("SchoolData.Models.Class", "Class")
                        .WithMany("IdCourse")
                        .HasForeignKey("ClassIdClass")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SchoolData.Models.Group", "Group")
                        .WithMany("IdCourse")
            ...
            modelBuilder.Entity("SchoolData.Models.EmergencyContact", b =>
                {
                    b.HasOne("SchoolData.Models.Student", "Students")
                        .WithMany("IdContact")
            ...
            modelBuilder.Entity("SchoolData.Models.Group", b =>
                {
                    b.HasOne("SchoolData.Models.Tutor", "Tutor")
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("SchoolData.Models.Pay", b =>
                {
                    b.HasOne("SchoolData.Models.PayType", "PayTypes")
                        .WithMany("IdPay")
            ...
            modelBuilder.Entity("SchoolData.Models.StudentCourse", b =>
                {
                    b.HasOne("SchoolData.Models.Course", "Courses")
            ...
            modelBuilder.Entity("SchoolData.Models.Teacher", b =>
                {
                    b.HasOne("SchoolData.Models.Employee", "Employee")
                        .WithMany("teachers")
